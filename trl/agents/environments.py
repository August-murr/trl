    ...
    def run_agent(
            ...
            if code_batch:
                try:
                    ...
                    for (conversation, token_count), result in zip(conversations_pending_code, execution_results):
                        ...
                        code_output_token_count = len(self.tokenizer.encode(code_output, add_special_tokens=False))
        ...
        completed_conversations = [
            self.tokenizer.decode(
                self.tokenizer.encode(conv, add_special_tokens=False)[: generation_config.max_tokens],
